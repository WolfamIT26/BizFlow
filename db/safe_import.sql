-- =====================================================
-- SCRIPT IMPORT DỮ LIỆU AN TOÀN
-- Chỉ INSERT dữ liệu mới, không xóa dữ liệu cũ
-- Sử dụng INSERT IGNORE để bỏ qua bản ghi trùng ID
-- =====================================================
...
-- 4. USERS
-- =====================================================
INSERT IGNORE INTO `users` (`id`, `username`, `password`, `email`, `full_name`, `phone_number`, `role`, `enabled`, `branch_id`, `created_at`, `updated_at`, `note`) VALUES
...
-- =====================================================
-- 5. PRODUCTS (150 sản phẩm)
-- =====================================================
INSERT IGNORE INTO `products` (`product_id`, `product_name`, `sku`, `barcode`, `category_id`, `unit`, `price`, `cost_price`, `status`, `description`, `created_at`, `updated_at`, `active`, `code`, `name`, `stock`) VALUES
...
-- HOÀN THÀNH
-- =====================================================
SELECT 'Import dữ liệu thành công!' AS message;
SELECT 'Các bản ghi trùng ID đã được bỏ qua tự động' AS note;
