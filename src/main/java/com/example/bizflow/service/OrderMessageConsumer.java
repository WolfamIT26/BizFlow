...
public class OrderMessageConsumer {
    ...
    public void handleOrderQueue(OrderMessage orderMessage) {
        try {
            ...
            // TODO: Xử lý lưu trữ lịch sử đơn hàng vào database hoặc log system
    ...
    public void handleNotificationQueue(OrderMessage orderMessage) {
        try {
            ...
            // TODO: Gửi email, SMS hoặc push notification cho khách hàng
            // Ví dụ:
    ...
    public void handleInventoryQueue(OrderMessage orderMessage) {
        try {
            ...
            // TODO: Cập nhật số lượng tồn kho sau khi bán
