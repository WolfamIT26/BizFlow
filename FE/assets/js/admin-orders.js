...
const ORDER_SERVICE_BASE = resolveServiceBase('ORDER_SERVICE_URL', '/order');
const apiEndpoints = {
    orders: `${ORDER_SERVICE_BASE}/api/admin/orders`,
    branches: `${BACKEND_API_BASE}/dashboard/branches`
};
