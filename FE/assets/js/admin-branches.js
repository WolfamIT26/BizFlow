...
const BRANCH_SERVICE_BASE = resolveServiceBase('BRANCH_SERVICE_URL', '/branch');

const endpoints = {
    summary: `${BRANCH_SERVICE_BASE}/api/admin/branches/summary`,
    growth: (branchId) => `${BRANCH_SERVICE_BASE}/api/admin/branches/${branchId}/growth?months=6`
};
...
function resolveServiceBase(configKey, fallback) {
    const configured = window[configKey];
    if (configured) {
