...
public class ProductController {
    ...
    // TODO: Call inventory-service via RestTemplate or Feign Client
    // @Autowired
    ...
    public ResponseEntity<?> getAllProducts(@RequestParam(value = "search", required = false) String search) {
        try {
            ...
            // // applyInventoryStocks(products); // TODO: Call inventory-service API // TODO: Call inventory-service via RestTemplate or Feign
            boolean showCostPrice = true; // Always show cost price for testing
    ...
    public ResponseEntity<?> getProductById(@PathVariable @NonNull Long id) {
        try {
            return productRepository.findById(id)
                    .map(product -> {
                        // TODO: Call inventory-service to get stock
    ...
    public ResponseEntity<?> createProduct(@RequestBody @NonNull Product product) {
        try {
            ...
            // TODO: Call inventory-service to create initial stock
    ...
    // TODO: Move to inventory-service or call via RestTemplate
    /*
